    ...
    new CampaignModel({
      ...
      sets: [
        new SetModel({
          ...
          // prettier-ignore
          stages: [
            new StageModel({ kx: 215, ty: 50, th: 190, showPuck: true, name: `you control gravity`, description: `the puck falls when you press/hold the "drop" button`, difficulty: new DifficultyModel({ speed: 200 }) }),
